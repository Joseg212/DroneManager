...
$(document).ready(function(){
	...
	/* Definicion de la ventanas modales  */

	$("#win-modal-01").width($(window).width());
	$("#win-modal-01").height($(window).height());

	$("#win-modal-02").width($(window).width());
	$("#win-modal-02").height($(window).height());
	...
	$(document).on("click",".dm-close-window-01",function(e){
		e.preventDefault();
	...
	$(document).on("click",".dm-close-window-02",function(e){
		e.preventDefault();
	...
	$(document).on("click",".dm-close-window-03",function(e){
		e.preventDefault();
